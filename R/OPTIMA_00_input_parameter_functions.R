...
load_all_params <- function(file.init = NULL,
  ...
  l_params_all <- list(
    ...
    n_BUPC_OD_NI_ub = df_overdose["high", "BUPC_OD_NI"],
    n_MET_OD_NI_ub = df_overdose["high", "MET_OD_NI"],
    n_METC_OD_NI_ub = df_overdose["high", "METC_OD_NI"],
    ...
    p_HIV_HCV_BUPC_INJ = df_hcv["pe", "COI_BUPC_INJ"],
    p_HIV_HCV_MET_INJ  = df_hcv["pe", "COI_MET_INJ"],
    p_HIV_HCV_METC_INJ = df_hcv["pe", "COI_METC_INJ"],
    ...
    u_BUPC_NI_NEG = df_qalys["pe", "BUPC_NI_NEG"],
    u_MET_NI_NEG  = df_qalys["pe", "MET_NI_NEG"],
    u_METC_NI_NEG = df_qalys["pe", "METC_NI_NEG"],
    ...
    u_BUPC_INJ_NEG = df_qalys["pe", "BUPC_INJ_NEG"],
    u_MET_INJ_NEG  = df_qalys["pe", "MET_INJ_NEG"],
    u_METC_INJ_NEG = df_qalys["pe", "METC_INJ_NEG"],
    ...
    u_BUPC_NI_POS = df_qalys["pe", "BUPC_NI_POS"],
    u_MET_NI_POS  = df_qalys["pe", "MET_NI_POS"],
    u_METC_NI_POS = df_qalys["pe", "METC_NI_POS"],
    ...
    u_BUPC_INJ_POS = df_qalys["pe", "BUPC_INJ_POS"],
    u_MET_INJ_POS  = df_qalys["pe", "MET_INJ_POS"],
    u_METC_INJ_POS = df_qalys["pe", "METC_INJ_POS"],
