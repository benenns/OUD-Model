...
markov_model <- function(l_params_all, err_stop = FALSE, verbose = FALSE, checks = FALSE, cali = FALSE){
  ...
  m_remain_4 <- a_remain[, 4, ]### R&R MODIFICATION ###
  
  m_leave_1 <- 1 - a_remain[, 1, ]
  m_leave_2 <- 1 - a_remain[, 2, ]
  m_leave_3 <- 1 - a_remain[, 3, ]
  m_leave_4 <- 1 - a_remain[, 4, ]### R&R MODIFICATION ###
  ...
  if(checks){
    ...
    write.csv(m_remain_4,"checks/state-time dependent transitions/m_TDP_4.csv", row.names = TRUE)### R&R MODIFICATION ###
    ...
    write.csv(m_leave_4,"checks/state-time dependent transitions/m_leave_4.csv", row.names = TRUE)### R&R MODIFICATION ###
  } else{}
  ...
  # Three transition arrays to account for model-time-varying overdose (2017, 2018, 2019, 2020+)
  ...
  for (i in 1){
    ...
    a_TDP_4[, , i] <- a_UP_first[, , 4] * m_leave_4[, i]### R&R MODIFICATION ###
  }
  ...
  for (i in 2:n_t){
    ...
    a_TDP_4[, , i] <- a_UP[, , 4] * m_leave_4[, i]### R&R MODIFICATION ###
  }
  ...
  for (i in 1:n_t){
    ...
    a_TDP_4[EP1 & BUP & NI, EP1 & BUP & NI, i]   <- m_remain_4[EP1 & BUP & NI, i]### R&R MODIFICATION ###
    # BUPC
    ...
    a_TDP_4[EP1 & BUPC & NI, EP1 & BUPC & NI, i] <- m_remain_4[EP1 & BUPC & NI, i]### R&R MODIFICATION ###
    # MET
    ...
    a_TDP_4[EP1 & MET & NI, EP1 & MET & NI, i]   <- m_remain_4[EP1 & MET & NI, i]### R&R MODIFICATION ###
    # METC
    ...
    a_TDP_4[EP1 & METC & NI, EP1 & METC & NI, i] <- m_remain_4[EP1 & METC & NI, i]### R&R MODIFICATION ###
    # ABS
    ...
    a_TDP_4[EP1 & ABS & NI, EP1 & ABS & NI, i]   <- m_remain_4[EP1 & ABS & NI, i]### R&R MODIFICATION ###
    # REL
    ...
    a_TDP_4[EP1 & REL & NI, EP1 & REL & NI, i]   <- m_remain_4[EP1 & REL & NI, i]### R&R MODIFICATION ###
    # ODF
    ...
    a_TDP_4[EP1 & ODF & NI, EP1 & ODF & NI, i]   <- m_remain_4[EP1 & ODF & NI, i]### R&R MODIFICATION ###
    ...
    a_TDP_4[EP2 & BUP & NI, EP2 & BUP & NI, i] <- m_remain_4[EP2 & BUP & NI, i]### R&R MODIFICATION ###
    # BUPC
    ...
    a_TDP_4[EP2 & BUPC & NI, EP2 & BUPC & NI, i] <- m_remain_4[EP2 & BUPC & NI, i]### R&R MODIFICATION ###
    # MET
    ...
    a_TDP_4[EP2 & MET & NI, EP2 & MET & NI, i] <- m_remain_4[EP2 & MET & NI, i]### R&R MODIFICATION ###
    # METC
    ...
    a_TDP_4[EP2 & METC & NI, EP2 & METC & NI, i] <- m_remain_4[EP2 & METC & NI, i]### R&R MODIFICATION ###
    # ABS
    ...
    a_TDP_4[EP2 & ABS & NI, EP2 & ABS & NI, i] <- m_remain_4[EP2 & ABS & NI, i]### R&R MODIFICATION ###
    # REL
    ...
    a_TDP_4[EP2 & REL & NI, EP2 & REL & NI, i] <- m_remain_4[EP2 & REL & NI, i]### R&R MODIFICATION ###
    # ODF
    ...
    a_TDP_4[EP2 & ODF & NI, EP2 & ODF & NI, i] <- m_remain_4[EP2 & ODF & NI, i]### R&R MODIFICATION ###
    ...
    a_TDP_4[EP3 & BUP & NI, EP3 & BUP & NI, i] <- m_remain_4[EP3 & BUP & NI, i]### R&R MODIFICATION ###
    # BUPC
    ...
    a_TDP_4[EP3 & BUPC & NI, EP3 & BUPC & NI, i] <- m_remain_4[EP3 & BUPC & NI, i]### R&R MODIFICATION ###
    # MET
    ...
    a_TDP_4[EP3 & MET & NI, EP3 & MET & NI, i] <- m_remain_4[EP3 & MET & NI, i]### R&R MODIFICATION ###
    # METC
    ...
    a_TDP_4[EP3 & METC & NI, EP3 & METC & NI, i] <- m_remain_4[EP3 & METC & NI, i]### R&R MODIFICATION ###
    # ABS
    ...
    a_TDP_4[EP3 & ABS & NI, EP3 & ABS & NI, i] <- m_remain_4[EP3 & ABS & NI, i]### R&R MODIFICATION ###
    # REL
    ...
    a_TDP_4[EP3 & REL & NI, EP3 & REL & NI, i] <- m_remain_4[EP3 & REL & NI, i]### R&R MODIFICATION ###
    # ODF
    ...
    a_TDP_4[EP3 & ODF & NI, EP3 & ODF & NI, i] <- m_remain_4[EP3 & ODF & NI, i]### R&R MODIFICATION ###
    ...
    a_TDP_4[EP1 & BUP & INJ, EP1 & BUP & INJ, i] <- m_remain_4[EP1 & BUP & INJ, i]### R&R MODIFICATION ###
    # BUPC
    ...
    a_TDP_4[EP1 & BUPC & INJ, EP1 & BUPC & INJ, i] <- m_remain_4[EP1 & BUPC & INJ, i]### R&R MODIFICATION ###
    # MET
    ...
    a_TDP_4[EP1 & MET & INJ, EP1 & MET & INJ, i] <- m_remain_4[EP1 & MET & INJ, i]### R&R MODIFICATION ###
    # METC
    ...
    a_TDP_4[EP1 & METC & INJ, EP1 & METC & INJ, i] <- m_remain_4[EP1 & METC & INJ, i]### R&R MODIFICATION ###
    # ABS
    ...
    a_TDP_4[EP1 & ABS & INJ, EP1 & ABS & INJ, i] <- m_remain_4[EP1 & ABS & INJ, i]### R&R MODIFICATION ###
    # REL
    ...
    a_TDP_4[EP1 & REL & INJ, EP1 & REL & INJ, i] <- m_remain_4[EP1 & REL & INJ, i]### R&R MODIFICATION ###
    # ODF
    ...
    a_TDP_4[EP1 & ODF & INJ, EP1 & ODF & INJ, i] <- m_remain_4[EP1 & ODF & INJ, i]### R&R MODIFICATION ###
    ...
    a_TDP_4[EP2 & BUP & INJ, EP2 & BUP & INJ, i] <- m_remain_4[EP2 & BUP & INJ, i]### R&R MODIFICATION ###
    # BUPC
    ...
    a_TDP_4[EP2 & BUPC & INJ, EP2 & BUPC & INJ, i] <- m_remain_4[EP2 & BUPC & INJ, i]### R&R MODIFICATION ###
    # MET
    ...
    a_TDP_4[EP2 & MET & INJ, EP2 & MET & INJ, i] <- m_remain_4[EP2 & MET & INJ, i]### R&R MODIFICATION ###
    # METC
    ...
    a_TDP_4[EP2 & METC & INJ, EP2 & METC & INJ, i] <- m_remain_4[EP2 & METC & INJ, i]### R&R MODIFICATION ###
    # ABS
    ...
    a_TDP_4[EP2 & ABS & INJ, EP2 & ABS & INJ, i] <- m_remain_4[EP2 & ABS & INJ, i]### R&R MODIFICATION ###
    # REL
    ...
    a_TDP_4[EP2 & REL & INJ, EP2 & REL & INJ, i] <- m_remain_4[EP2 & REL & INJ, i]### R&R MODIFICATION ###
    # ODF
    ...
    a_TDP_4[EP2 & ODF & INJ, EP2 & ODF & INJ, i] <- m_remain_4[EP2 & ODF & INJ, i]### R&R MODIFICATION ###
    ...
    a_TDP_4[EP3 & BUP & INJ, EP3 & BUP & INJ, i] <- m_remain_4[EP3 & BUP & INJ, i]### R&R MODIFICATION ###
    # BUPC
    ...
    a_TDP_4[EP3 & BUPC & INJ, EP3 & BUPC & INJ, i] <- m_remain_4[EP3 & BUPC & INJ, i]### R&R MODIFICATION ###
    # MET
    ...
    a_TDP_4[EP3 & MET & INJ, EP3 & MET & INJ, i] <- m_remain_4[EP3 & MET & INJ, i]### R&R MODIFICATION ###
    # METC
    ...
    a_TDP_4[EP3 & METC & INJ, EP3 & METC & INJ, i] <- m_remain_4[EP3 & METC & INJ, i]### R&R MODIFICATION ###
    # ABS
    ...
    a_TDP_4[EP3 & ABS & INJ, EP3 & ABS & INJ, i] <- m_remain_4[EP3 & ABS & INJ, i]### R&R MODIFICATION ###
    # REL
    ...
    a_TDP_4[EP3 & REL & INJ, EP3 & REL & INJ, i] <- m_remain_4[EP3 & REL & INJ, i]### R&R MODIFICATION ###
    # ODF
    ...
    a_TDP_4[EP3 & ODF & INJ, EP3 & ODF & INJ, i] <- m_remain_4[EP3 & ODF & INJ, i]### R&R MODIFICATION ###
  }
  
  if(checks){
    # State transitions pre-overdose
    # First month (state-time)
    write.csv(a_TDP_1[, , 1], "checks/state transitions/a_TDP_pre_OD_2017.csv")### R&R MODIFICATION ###
  ...
  for (i in 1){
    ...
    a_TDP_4[, , i] <- a_TDP_4[, , i] * m_non_OD_first[, 4]### R&R MODIFICATION ###
  }
  ## All transitions 2+ months
  for (i in 2:n_t){
    ...
    a_TDP_4[, , i] <- a_TDP_4[, , i] * m_non_OD[, 4]### R&R MODIFICATION ###
  }
  ...
  if(checks){
    ...
    # First month (state-time)
    write.csv(a_TDP_1[, , 1], "checks/state transitions/a_TDP_post_OD_2017.csv")### R&R MODIFICATION ###
  ...
  a_TDP_4[NEG & NI, BUP & NI & NEG, ]  <- a_TDP_4[NEG & NI, BUP & NI & NEG, ] * (1 - p_HIV_BUP_NI - p_HCV_BUP_NI)### R&R MODIFICATION ###
  ...
  a_TDP_4[NEG & NI, BUP & NI & HIV, ]  <- a_TDP_4[NEG & NI, BUP & NI & HIV, ] * p_HIV_BUP_NI### R&R MODIFICATION ###
  ...
  a_TDP_4[NEG & NI, BUP & NI & HCV, ]  <- a_TDP_4[NEG & NI, BUP & NI & HCV, ] * p_HCV_BUP_NI### R&R MODIFICATION ###
  # From HIV
  ...
  a_TDP_4[HIV & NI, BUP & NI & HIV, ]  <- a_TDP_4[HIV & NI, BUP & NI & HIV, ] * (1 - p_HIV_HCV_BUP_NI)### R&R MODIFICATION ###
  ...
  a_TDP_4[HIV & NI, BUP & NI & COI, ]  <- a_TDP_4[HIV & NI, BUP & NI & COI, ] * p_HIV_HCV_BUP_NI### R&R MODIFICATION ###
  # From HCV
  ...
  a_TDP_4[HCV & NI, BUP & NI & HCV, ]  <- a_TDP_4[HCV & NI, BUP & NI & HCV, ] * (1 - p_HCV_HIV_BUP_NI)### R&R MODIFICATION ###
  ...
  a_TDP_4[HCV & NI, BUP & NI & COI, ]  <- a_TDP_4[HCV & NI, BUP & NI & COI, ] * p_HCV_HIV_BUP_NI### R&R MODIFICATION ###
  # BUPC
  # From NEG
  ...
  a_TDP_4[NEG & NI, BUPC & NI & NEG, ]  <- a_TDP_4[NEG & NI, BUPC & NI & NEG, ] * (1 - p_HIV_BUPC_NI - p_HCV_BUPC_NI)### R&R MODIFICATION ###
  ...
  a_TDP_4[NEG & NI, BUPC & NI & HIV, ]  <- a_TDP_4[NEG & NI, BUPC & NI & HIV, ] * p_HIV_BUPC_NI### R&R MODIFICATION ###
  ...
  a_TDP_4[NEG & NI, BUPC & NI & HCV, ]  <- a_TDP_4[NEG & NI, BUPC & NI & HCV, ] * p_HCV_BUPC_NI### R&R MODIFICATION ###
  # From HIV
  ...
  a_TDP_4[HIV & NI, BUPC & NI & HIV, ]  <- a_TDP_4[HIV & NI, BUPC & NI & HIV, ] * (1 - p_HIV_HCV_BUPC_NI)### R&R MODIFICATION ###
  ...
  a_TDP_4[HIV & NI, BUPC & NI & COI, ]  <- a_TDP_4[HIV & NI, BUPC & NI & COI, ] * p_HIV_HCV_BUPC_NI### R&R MODIFICATION ###
  # From HCV
  ...
  a_TDP_4[HCV & NI, BUPC & NI & HCV, ]  <- a_TDP_4[HCV & NI, BUPC & NI & HCV, ] * (1 - p_HCV_HIV_BUPC_NI)### R&R MODIFICATION ###
  ...
  a_TDP_4[HCV & NI, BUPC & NI & COI, ]  <- a_TDP_4[HCV & NI, BUPC & NI & COI, ] * p_HCV_HIV_BUPC_NI### R&R MODIFICATION ###
  ...
  a_TDP_4[NEG & NI, MET & NI & NEG, ]  <- a_TDP_4[NEG & NI, MET & NI & NEG, ] * (1 - p_HIV_MET_NI - p_HCV_MET_NI)### R&R MODIFICATION ###
  ...
  a_TDP_4[NEG & NI, MET & NI & HIV, ]  <- a_TDP_4[NEG & NI, MET & NI & HIV, ] * p_HIV_MET_NI### R&R MODIFICATION ###
  ...
  a_TDP_4[NEG & NI, MET & NI & HCV, ]  <- a_TDP_4[NEG & NI, MET & NI & HCV, ] * p_HCV_MET_NI### R&R MODIFICATION ###
  # From HIV
  ...
  a_TDP_4[HIV & NI, MET & NI & HIV, ]  <- a_TDP_4[HIV & NI, MET & NI & HIV, ] * (1 - p_HIV_HCV_MET_NI)### R&R MODIFICATION ###
  ...
  a_TDP_4[HIV & NI, MET & NI & COI, ]  <- a_TDP_4[HIV & NI, MET & NI & COI, ] * p_HIV_HCV_MET_NI### R&R MODIFICATION ###
  # From HCV
  ...
  a_TDP_4[HCV & NI, MET & NI & HCV, ]  <- a_TDP_4[HCV & NI, MET & NI & HCV, ] * (1 - p_HCV_HIV_MET_NI)### R&R MODIFICATION ###
  ...
  a_TDP_4[HCV & NI, MET & NI & COI, ]  <- a_TDP_4[HCV & NI, MET & NI & COI, ] * p_HCV_HIV_MET_NI### R&R MODIFICATION ###
  ...
  a_TDP_4[NEG & NI, METC & NI & NEG, ]  <- a_TDP_4[NEG & NI, METC & NI & NEG, ] * (1 - p_HIV_METC_NI - p_HCV_METC_NI)### R&R MODIFICATION ###
  ...
  a_TDP_4[NEG & NI, METC & NI & HIV, ]  <- a_TDP_4[NEG & NI, METC & NI & HIV, ] * p_HIV_METC_NI### R&R MODIFICATION ###
  ...
  a_TDP_4[NEG & NI, METC & NI & HCV, ]  <- a_TDP_4[NEG & NI, METC & NI & HCV, ] * p_HCV_METC_NI### R&R MODIFICATION ###
  # From HIV
  ...
  a_TDP_4[HIV & NI, METC & NI & HIV, ]  <- a_TDP_4[HIV & NI, METC & NI & HIV, ] * (1 - p_HIV_HCV_METC_NI)### R&R MODIFICATION ###
  ...
  a_TDP_4[HIV & NI, METC & NI & COI, ]  <- a_TDP_4[HIV & NI, METC & NI & COI, ] * p_HIV_HCV_METC_NI### R&R MODIFICATION ###
  # From HCV
  ...
  a_TDP_4[HCV & NI, METC & NI & HCV, ]  <- a_TDP_4[HCV & NI, METC & NI & HCV, ] * (1 - p_HCV_HIV_METC_NI)### R&R MODIFICATION ###
  ...
  a_TDP_4[HCV & NI, METC & NI & COI, ]  <- a_TDP_4[HCV & NI, METC & NI & COI, ] * p_HCV_HIV_METC_NI### R&R MODIFICATION ###
  # REL
  # From NEG
  ...
  a_TDP_4[NEG & NI, REL & NI & NEG, ]  <- a_TDP_4[NEG & NI, REL & NI & NEG, ] * (1 - p_HIV_REL_NI - p_HCV_REL_NI)### R&R MODIFICATION ###
  ...
  a_TDP_4[NEG & NI, REL & NI & HIV, ]  <- a_TDP_4[NEG & NI, REL & NI & HIV, ] * p_HIV_REL_NI### R&R MODIFICATION ###
  ...
  a_TDP_4[NEG & NI, REL & NI & HCV, ]  <- a_TDP_4[NEG & NI, REL & NI & HCV, ] * p_HCV_REL_NI### R&R MODIFICATION ###
  # From HIV
  ...
  a_TDP_4[HIV & NI, REL & NI & HIV, ]  <- a_TDP_4[HIV & NI, REL & NI & HIV, ] * (1 - p_HIV_HCV_REL_NI)### R&R MODIFICATION ###
  ...
  a_TDP_4[HIV & NI, REL & NI & COI, ]  <- a_TDP_4[HIV & NI, REL & NI & COI, ] * p_HIV_HCV_REL_NI### R&R MODIFICATION ###
  # From HCV
  ...
  a_TDP_4[HCV & NI, REL & NI & HCV, ]  <- a_TDP_4[HCV & NI, REL & NI & HCV, ] * (1 - p_HCV_HIV_REL_NI)### R&R MODIFICATION ###
  ...
  a_TDP_4[HCV & NI, REL & NI & COI, ]  <- a_TDP_4[HCV & NI, REL & NI & COI, ] * p_HCV_HIV_REL_NI### R&R MODIFICATION ###
  # ODN
  # From NEG
  ...
  a_TDP_4[NEG & NI, ODN & NI & NEG, ]  <- a_TDP_4[NEG & NI, ODN & NI & NEG, ] * (1 - p_HIV_ODN_NI - p_HCV_ODN_NI)### R&R MODIFICATION ###
  ...
  a_TDP_4[NEG & NI, ODN & NI & HIV, ]  <- a_TDP_4[NEG & NI, ODN & NI & HIV, ] * p_HIV_ODN_NI### R&R MODIFICATION ###
  ...
  a_TDP_4[NEG & NI, ODN & NI & HCV, ]  <- a_TDP_4[NEG & NI, ODN & NI & HCV, ] * p_HCV_ODN_NI### R&R MODIFICATION ###
  # From HIV
  ...
  a_TDP_4[HIV & NI, ODN & NI & HIV, ]  <- a_TDP_4[HIV & NI, ODN & NI & HIV, ] * (1 - p_HIV_HCV_ODN_NI)### R&R MODIFICATION ###
  ...
  a_TDP_4[HIV & NI, ODN & NI & COI, ]  <- a_TDP_4[HIV & NI, ODN & NI & COI, ] * p_HIV_HCV_ODN_NI### R&R MODIFICATION ###
  # From HCV
  ...
  a_TDP_4[HCV & NI, ODN & NI & HCV, ]  <- a_TDP_4[HCV & NI, ODN & NI & HCV, ] * (1 - p_HCV_HIV_ODN_NI)### R&R MODIFICATION ###
  ...
  a_TDP_4[HCV & NI, ODN & NI & COI, ]  <- a_TDP_4[HCV & NI, ODN & NI & COI, ] * p_HCV_HIV_ODN_NI### R&R MODIFICATION ###
  ...
  a_TDP_4[NEG & NI, ODF & NI & NEG, ]  <- a_TDP_4[NEG & NI, ODF & NI & NEG, ] * 1### R&R MODIFICATION ###
  ...
  a_TDP_4[NEG & NI, ODF & NI & HIV, ]  <- a_TDP_4[NEG & NI, ODF & NI & HIV, ] * 0### R&R MODIFICATION ###
  ...
  a_TDP_4[NEG & NI, ODF & NI & HCV, ]  <- a_TDP_4[NEG & NI, ODF & NI & HCV, ] * 0### R&R MODIFICATION ###
  # From HIV
  ...
  a_TDP_4[HIV & NI, ODF & NI & HIV, ]  <- a_TDP_4[HIV & NI, ODF & NI & HIV, ] * 1### R&R MODIFICATION ###
  ...
  a_TDP_4[HIV & NI, ODF & NI & COI, ]  <- a_TDP_4[HIV & NI, ODF & NI & COI, ] * 0### R&R MODIFICATION ###
  # From HCV
  ...
  a_TDP_4[HCV & NI, ODF & NI & HCV, ]  <- a_TDP_4[HCV & NI, ODF & NI & HCV, ] * 1### R&R MODIFICATION ###
  ...
  a_TDP_4[HCV & NI, ODF & NI & COI, ]  <- a_TDP_4[HCV & NI, ODF & NI & COI, ] * 0### R&R MODIFICATION ###
  ...
  a_TDP_4[NEG & NI, ABS & NI & NEG, ]  <- a_TDP_4[NEG & NI, ABS & NI & NEG, ] * (1 - p_HIV_ABS_NI - p_HCV_ABS_NI)### R&R MODIFICATION ###
  ...
  a_TDP_4[NEG & NI, ABS & NI & HIV, ]  <- a_TDP_4[NEG & NI, ABS & NI & HIV, ] * p_HIV_ABS_NI### R&R MODIFICATION ###
  ...
  a_TDP_4[NEG & NI, ABS & NI & HCV, ]  <- a_TDP_4[NEG & NI, ABS & NI & HCV, ] * p_HCV_ABS_NI### R&R MODIFICATION ###
  # From HIV
  ...
  a_TDP_4[HIV & NI, ABS & NI & HIV, ]  <- a_TDP_4[HIV & NI, ABS & NI & HIV, ] * (1 - p_HIV_HCV_ABS_NI)### R&R MODIFICATION ###
  ...
  a_TDP_4[HIV & NI, ABS & NI & COI, ]  <- a_TDP_4[HIV & NI, ABS & NI & COI, ] * p_HIV_HCV_ABS_NI### R&R MODIFICATION ###
  # From HCV
  ...
  a_TDP_4[HCV & NI, ABS & NI & HCV, ]  <- a_TDP_4[HCV & NI, ABS & NI & HCV, ] * (1 - p_HCV_HIV_ABS_NI)### R&R MODIFICATION ###
  ...
  a_TDP_4[HCV & NI, ABS & NI & COI, ]  <- a_TDP_4[HCV & NI, ABS & NI & COI, ] * p_HCV_HIV_ABS_NI### R&R MODIFICATION ###
  ...
  a_TDP_4[NEG & INJ, BUP & INJ & NEG, ]  <- a_TDP_4[NEG & INJ, BUP & INJ & NEG, ] * (1 - p_HIV_BUP_INJ - p_HCV_BUP_INJ)### R&R MODIFICATION ###
  ...
  a_TDP_4[NEG & INJ, BUP & INJ & HIV, ]  <- a_TDP_4[NEG & INJ, BUP & INJ & HIV, ] * p_HIV_BUP_INJ### R&R MODIFICATION ###
  ...
  a_TDP_4[NEG & INJ, BUP & INJ & HCV, ]  <- a_TDP_4[NEG & INJ, BUP & INJ & HCV, ] * p_HCV_BUP_INJ### R&R MODIFICATION ###
  # From HIV
  ...
  a_TDP_4[HIV & INJ, BUP & INJ & HIV, ]  <- a_TDP_4[HIV & INJ, BUP & INJ & HIV, ] * (1 - p_HIV_HCV_BUP_INJ)### R&R MODIFICATION ###
  ...
  a_TDP_4[HIV & INJ, BUP & INJ & COI, ]  <- a_TDP_4[HIV & INJ, BUP & INJ & COI, ] * p_HIV_HCV_BUP_INJ### R&R MODIFICATION ###
  # From HCV
  ...
  a_TDP_4[HCV & INJ, BUP & INJ & HCV, ]  <- a_TDP_4[HCV & INJ, BUP & INJ & HCV, ] * (1 - p_HCV_HIV_BUP_INJ)### R&R MODIFICATION ###
  ...
  a_TDP_4[HCV & INJ, BUP & INJ & COI, ]  <- a_TDP_4[HCV & INJ, BUP & INJ & COI, ] * p_HCV_HIV_BUP_INJ### R&R MODIFICATION ###
  # BUPC
  # From NEG
  ...
  a_TDP_4[NEG & INJ, BUPC & INJ & NEG, ]  <- a_TDP_4[NEG & INJ, BUPC & INJ & NEG, ] * (1 - p_HIV_BUPC_INJ - p_HCV_BUPC_INJ)### R&R MODIFICATION ###
  ...
  a_TDP_4[NEG & INJ, BUPC & INJ & HIV, ]  <- a_TDP_4[NEG & INJ, BUPC & INJ & HIV, ] * p_HIV_BUPC_INJ### R&R MODIFICATION ###
  ...
  a_TDP_4[NEG & INJ, BUPC & INJ & HCV, ]  <- a_TDP_4[NEG & INJ, BUPC & INJ & HCV, ] * p_HCV_BUPC_INJ### R&R MODIFICATION ###
  # From HIV
  ...
  a_TDP_4[HIV & INJ, BUPC & INJ & HIV, ]  <- a_TDP_4[HIV & INJ, BUPC & INJ & HIV, ] * (1 - p_HIV_HCV_BUPC_INJ)### R&R MODIFICATION ###
  ...
  a_TDP_4[HIV & INJ, BUPC & INJ & COI, ]  <- a_TDP_4[HIV & INJ, BUPC & INJ & COI, ] * p_HIV_HCV_BUPC_INJ### R&R MODIFICATION ###
  # From HCV
  ...
  a_TDP_4[HCV & INJ, BUPC & INJ & HCV, ]  <- a_TDP_4[HCV & INJ, BUPC & INJ & HCV, ] * (1 - p_HCV_HIV_BUPC_INJ)### R&R MODIFICATION ###
  ...
  a_TDP_4[HCV & INJ, BUPC & INJ & COI, ]  <- a_TDP_4[HCV & INJ, BUPC & INJ & COI, ] * p_HCV_HIV_BUPC_INJ### R&R MODIFICATION ###
  ...
  a_TDP_4[NEG & INJ, MET & INJ & NEG, ]  <- a_TDP_4[NEG & INJ, MET & INJ & NEG, ] * (1 - p_HIV_MET_INJ - p_HCV_MET_INJ)### R&R MODIFICATION ###
  ...
  a_TDP_4[NEG & INJ, MET & INJ & HIV, ]  <- a_TDP_4[NEG & INJ, MET & INJ & HIV, ] * p_HIV_MET_INJ### R&R MODIFICATION ###
  ...
  a_TDP_4[NEG & INJ, MET & INJ & HCV, ]  <- a_TDP_4[NEG & INJ, MET & INJ & HCV, ] * p_HCV_MET_INJ### R&R MODIFICATION ###
  # From HIV
  ...
  a_TDP_4[HIV & INJ, MET & INJ & HIV, ]  <- a_TDP_4[HIV & INJ, MET & INJ & HIV, ] * (1 - p_HIV_HCV_MET_INJ)### R&R MODIFICATION ###
  ...
  a_TDP_4[HIV & INJ, MET & INJ & COI, ]  <- a_TDP_4[HIV & INJ, MET & INJ & COI, ] * p_HIV_HCV_MET_INJ### R&R MODIFICATION ###
  # From HCV
  ...
  a_TDP_4[HCV & INJ, MET & INJ & HCV, ]  <- a_TDP_4[HCV & INJ, MET & INJ & HCV, ] * (1 - p_HCV_HIV_MET_INJ)### R&R MODIFICATION ###
  ...
  a_TDP_4[HCV & INJ, MET & INJ & COI, ]  <- a_TDP_4[HCV & INJ, MET & INJ & COI, ] * p_HCV_HIV_MET_INJ### R&R MODIFICATION ###
  ...
  a_TDP_4[NEG & INJ, METC & INJ & NEG, ]  <- a_TDP_4[NEG & INJ, METC & INJ & NEG, ] * (1 - p_HIV_METC_INJ - p_HCV_METC_INJ)### R&R MODIFICATION ###
  ...
  a_TDP_4[NEG & INJ, METC & INJ & HIV, ]  <- a_TDP_4[NEG & INJ, METC & INJ & HIV, ] * p_HIV_METC_INJ### R&R MODIFICATION ###
  ...
  a_TDP_4[NEG & INJ, METC & INJ & HCV, ]  <- a_TDP_4[NEG & INJ, METC & INJ & HCV, ] * p_HCV_METC_INJ### R&R MODIFICATION ###
  # From HIV
  ...
  a_TDP_4[HIV & INJ, METC & INJ & HIV, ]  <- a_TDP_4[HIV & INJ, METC & INJ & HIV, ] * (1 - p_HIV_HCV_METC_INJ)### R&R MODIFICATION ###
  ...
  a_TDP_4[HIV & INJ, METC & INJ & COI, ]  <- a_TDP_4[HIV & INJ, METC & INJ & COI, ] * p_HIV_HCV_METC_INJ### R&R MODIFICATION ###
  # From HCV
  ...
  a_TDP_4[HCV & INJ, METC & INJ & HCV, ]  <- a_TDP_4[HCV & INJ, METC & INJ & HCV, ] * (1 - p_HCV_HIV_METC_INJ)### R&R MODIFICATION ###
  ...
  a_TDP_4[HCV & INJ, METC & INJ & COI, ]  <- a_TDP_4[HCV & INJ, METC & INJ & COI, ] * p_HCV_HIV_METC_INJ### R&R MODIFICATION ###
  # REL
  # From NEG
  ...
  a_TDP_4[NEG & INJ, REL & INJ & NEG, ]  <- a_TDP_4[NEG & INJ, REL & INJ & NEG, ] * (1 - p_HIV_REL_INJ - p_HCV_REL_INJ)### R&R MODIFICATION ###
  ...
  a_TDP_4[NEG & INJ, REL & INJ & HIV, ]  <- a_TDP_4[NEG & INJ, REL & INJ & HIV, ] * p_HIV_REL_INJ### R&R MODIFICATION ###
  ...
  a_TDP_4[NEG & INJ, REL & INJ & HCV, ]  <- a_TDP_4[NEG & INJ, REL & INJ & HCV, ] * p_HCV_REL_INJ### R&R MODIFICATION ###
  # From HIV
  ...
  a_TDP_4[HIV & INJ, REL & INJ & HIV, ]  <- a_TDP_4[HIV & INJ, REL & INJ & HIV, ] * (1 - p_HIV_HCV_REL_INJ)### R&R MODIFICATION ###
  ...
  a_TDP_4[HIV & INJ, REL & INJ & COI, ]  <- a_TDP_4[HIV & INJ, REL & INJ & COI, ] * p_HIV_HCV_REL_INJ### R&R MODIFICATION ###
  # From HCV
  ...
  a_TDP_4[HCV & INJ, REL & INJ & HCV, ]  <- a_TDP_4[HCV & INJ, REL & INJ & HCV, ] * (1 - p_HCV_HIV_REL_INJ)### R&R MODIFICATION ###
  ...
  a_TDP_4[HCV & INJ, REL & INJ & COI, ]  <- a_TDP_4[HCV & INJ, REL & INJ & COI, ] * p_HCV_HIV_REL_INJ### R&R MODIFICATION ###
  # ODN
  # From NEG
  ...
  a_TDP_4[NEG & INJ, ODN & INJ & NEG, ]  <- a_TDP_4[NEG & INJ, ODN & INJ & NEG, ] * (1 - p_HIV_ODN_INJ - p_HCV_ODN_INJ)### R&R MODIFICATION ###
  ...
  a_TDP_4[NEG & INJ, ODN & INJ & HIV, ]  <- a_TDP_4[NEG & INJ, ODN & INJ & HIV, ] * p_HIV_ODN_INJ### R&R MODIFICATION ###
  ...
  a_TDP_4[NEG & INJ, ODN & INJ & HCV, ]  <- a_TDP_4[NEG & INJ, ODN & INJ & HCV, ] * p_HCV_ODN_INJ### R&R MODIFICATION ###
  # From HIV
  ...
  a_TDP_4[HIV & INJ, ODN & INJ & HIV, ]  <- a_TDP_4[HIV & INJ, ODN & INJ & HIV, ] * (1 - p_HIV_HCV_ODN_INJ)### R&R MODIFICATION ###
  ...
  a_TDP_4[HIV & INJ, ODN & INJ & COI, ]  <- a_TDP_4[HIV & INJ, ODN & INJ & COI, ] * p_HIV_HCV_ODN_INJ### R&R MODIFICATION ###
  # From HCV
  ...
  a_TDP_4[HCV & INJ, ODN & INJ & HCV, ]  <- a_TDP_4[HCV & INJ, ODN & INJ & HCV, ] * (1 - p_HCV_HIV_ODN_INJ)### R&R MODIFICATION ###
  ...
  a_TDP_4[HCV & INJ, ODN & INJ & COI, ]  <- a_TDP_4[HCV & INJ, ODN & INJ & COI, ] * p_HCV_HIV_ODN_INJ### R&R MODIFICATION ###
  ...
  a_TDP_4[NEG & INJ, ODF & INJ & NEG, ]  <- a_TDP_4[NEG & INJ, ODF & INJ & NEG, ] * 1### R&R MODIFICATION ###
  ...
  a_TDP_4[NEG & INJ, ODF & INJ & HIV, ]  <- a_TDP_4[NEG & INJ, ODF & INJ & HIV, ] * 0### R&R MODIFICATION ###
  ...
  a_TDP_4[NEG & INJ, ODF & INJ & HCV, ]  <- a_TDP_4[NEG & INJ, ODF & INJ & HCV, ] * 0### R&R MODIFICATION ###
  # From HIV
  ...
  a_TDP_4[HIV & INJ, ODF & INJ & HIV, ]  <- a_TDP_4[HIV & INJ, ODF & INJ & HIV, ] * 1### R&R MODIFICATION ###
  ...
  a_TDP_4[HIV & INJ, ODF & INJ & COI, ]  <- a_TDP_4[HIV & INJ, ODF & INJ & COI, ] * 0### R&R MODIFICATION ###
  # From HCV
  ...
  a_TDP_4[HCV & INJ, ODF & INJ & HCV, ]  <- a_TDP_4[HCV & INJ, ODF & INJ & HCV, ] * 1### R&R MODIFICATION ###
  ...
  a_TDP_4[HCV & INJ, ODF & INJ & COI, ]  <- a_TDP_4[HCV & INJ, ODF & INJ & COI, ] * 0### R&R MODIFICATION ###
  ...
  a_TDP_4[NEG & INJ, ABS & INJ & NEG, ]  <- a_TDP_4[NEG & INJ, ABS & INJ & NEG, ] * (1 - p_HIV_ABS_INJ - p_HCV_ABS_INJ)### R&R MODIFICATION ###
  ...
  a_TDP_4[NEG & INJ, ABS & INJ & HIV, ]  <- a_TDP_4[NEG & INJ, ABS & INJ & HIV, ] * p_HIV_ABS_INJ### R&R MODIFICATION ###
  ...
  a_TDP_4[NEG & INJ, ABS & INJ & HCV, ]  <- a_TDP_4[NEG & INJ, ABS & INJ & HCV, ] * p_HCV_ABS_INJ### R&R MODIFICATION ###
  # From HIV
  ...
  a_TDP_4[HIV & INJ, ABS & INJ & HIV, ]  <- a_TDP_4[HIV & INJ, ABS & INJ & HIV, ] * (1 - p_HIV_HCV_ABS_INJ)### R&R MODIFICATION ###
  ...
  a_TDP_4[HIV & INJ, ABS & INJ & COI, ]  <- a_TDP_4[HIV & INJ, ABS & INJ & COI, ] * p_HIV_HCV_ABS_INJ### R&R MODIFICATION ###
  # From HCV
  ...
  a_TDP_4[HCV & INJ, ABS & INJ & HCV, ]  <- a_TDP_4[HCV & INJ, ABS & INJ & HCV, ] * (1 - p_HCV_HIV_ABS_INJ)### R&R MODIFICATION ###
  ...
  a_TDP_4[HCV & INJ, ABS & INJ & COI, ]  <- a_TDP_4[HCV & INJ, ABS & INJ & COI, ] * p_HCV_HIV_ABS_INJ### R&R MODIFICATION ###

  #### Disallowed transitions (ensure that impossible transitions are set to zero) ####
  # Episode rules
  a_TDP_1[EP1, EP3, ] <- a_TDP_2[EP1, EP3, ] <- a_TDP_3[EP1, EP3, ] <- a_TDP_4[EP1, EP3, ] <- 0### R&R MODIFICATION ###
  a_TDP_1[EP2, EP1, ] <- a_TDP_2[EP2, EP1, ] <- a_TDP_3[EP2, EP1, ] <- a_TDP_4[EP2, EP1, ] <- 0### R&R MODIFICATION ###
  a_TDP_1[EP3, EP1, ] <- a_TDP_2[EP3, EP1, ] <- a_TDP_3[EP3, EP1, ] <- a_TDP_4[EP3, EP1, ] <- 0### R&R MODIFICATION ###
  a_TDP_1[EP3, EP2, ] <- a_TDP_2[EP3, EP2, ] <- a_TDP_3[EP3, EP2, ] <- a_TDP_4[EP3, EP2, ] <- 0### R&R MODIFICATION ###
  
  # Injection <> Non-injection
  a_TDP_1[INJ, NI,] <- a_TDP_2[INJ, NI,] <- a_TDP_3[INJ, NI,] <- a_TDP_4[INJ, NI,] <- 0### R&R MODIFICATION ###
  a_TDP_1[NI, INJ,] <- a_TDP_2[NI, INJ,] <- a_TDP_3[NI, INJ,] <- a_TDP_4[NI, INJ,] <- 0### R&R MODIFICATION ###
  
  # Seroconversions
  a_TDP_1[HIV, NEG, ] <- a_TDP_2[HIV, NEG, ] <- a_TDP_3[HIV, NEG, ] <- a_TDP_4[HIV, NEG, ] <- 0### R&R MODIFICATION ###
  a_TDP_1[HCV, NEG, ] <- a_TDP_2[HCV, NEG, ] <- a_TDP_3[HCV, NEG, ] <- a_TDP_4[HCV, NEG, ] <- 0### R&R MODIFICATION ###
  a_TDP_1[COI, NEG, ] <- a_TDP_2[COI, NEG, ] <- a_TDP_3[COI, NEG, ] <- a_TDP_4[COI, NEG, ] <- 0### R&R MODIFICATION ###
  a_TDP_1[HIV, HCV, ] <- a_TDP_2[HIV, HCV, ] <- a_TDP_3[HIV, HCV, ] <- a_TDP_4[HIV, HCV, ] <- 0### R&R MODIFICATION ###
  a_TDP_1[HCV, HIV, ] <- a_TDP_2[HCV, HIV, ] <- a_TDP_3[HCV, HIV, ] <- a_TDP_4[HCV, HIV, ] <- 0### R&R MODIFICATION ###
  a_TDP_1[COI, HIV, ] <- a_TDP_2[COI, HIV, ] <- a_TDP_3[COI, HIV, ] <- a_TDP_4[COI, HIV, ] <- 0### R&R MODIFICATION ### 
  a_TDP_1[COI, HCV, ] <- a_TDP_2[COI, HCV, ] <- a_TDP_3[COI, HCV, ] <- a_TDP_4[COI, HCV, ] <- 0### R&R MODIFICATION ###
  a_TDP_1[COI, NEG, ] <- a_TDP_2[COI, NEG, ] <- a_TDP_3[COI, NEG, ] <- a_TDP_4[COI, NEG, ] <- 0### R&R MODIFICATION ###
  a_TDP_1[NEG, COI, ] <- a_TDP_2[NEG, COI, ] <- a_TDP_3[NEG, COI, ] <- a_TDP_4[NEG, COI, ] <- 0### R&R MODIFICATION ###
  
  # Conditional transitions
  # Next episode with out-of-treatment(OOT) EPi -> treatment(TX) EP(i+1)
  a_TDP_1[all_TX & EP1, all_TX & EP2, ] <- a_TDP_2[all_TX & EP1, all_TX & EP2, ] <- a_TDP_3[all_TX & EP1, all_TX & EP2, ] <- a_TDP_4[all_TX & EP1, all_TX & EP2, ] <- 0### R&R MODIFICATION ###
  a_TDP_1[all_TX & EP1, all_TX & EP3, ] <- a_TDP_2[all_TX & EP1, all_TX & EP3, ] <- a_TDP_3[all_TX & EP1, all_TX & EP3, ] <- a_TDP_4[all_TX & EP1, all_TX & EP3, ] <- 0### R&R MODIFICATION ###
  a_TDP_1[all_TX & EP2, all_TX & EP3, ] <- a_TDP_2[all_TX & EP2, all_TX & EP3, ] <- a_TDP_3[all_TX & EP2, all_TX & EP3, ] <- a_TDP_4[all_TX & EP2, all_TX & EP3, ] <- 0### R&R MODIFICATION ###
  a_TDP_1[OOT & EP1, OOT & EP2, ] <- a_TDP_2[OOT & EP1, OOT & EP2, ] <- a_TDP_3[OOT & EP1, OOT & EP2, ] <- a_TDP_4[OOT & EP1, OOT & EP2, ] <- 0### R&R MODIFICATION ###
  a_TDP_1[OOT & EP1, OOT & EP3, ] <- a_TDP_2[OOT & EP1, OOT & EP3, ] <- a_TDP_3[OOT & EP1, OOT & EP3, ] <- a_TDP_4[OOT & EP1, OOT & EP3, ] <- 0### R&R MODIFICATION ###
  a_TDP_1[OOT & EP2, OOT & EP3, ] <- a_TDP_2[OOT & EP2, OOT & EP3, ] <- a_TDP_3[OOT & EP2, OOT & EP3, ] <- a_TDP_4[OOT & EP2, OOT & EP3, ] <- 0### R&R MODIFICATION ###
  a_TDP_1[all_TX & EP1, OOT & EP2, ] <- a_TDP_2[all_TX & EP1, OOT & EP2, ] <- a_TDP_3[all_TX & EP1, OOT & EP2, ] <- a_TDP_4[all_TX & EP1, OOT & EP2, ] <- 0### R&R MODIFICATION ###
  a_TDP_1[all_TX & EP2, OOT & EP3, ] <- a_TDP_2[all_TX & EP2, OOT & EP3, ] <- a_TDP_3[all_TX & EP2, OOT & EP3, ] <- a_TDP_4[all_TX & EP2, OOT & EP3, ] <- 0### R&R MODIFICATION ###
  a_TDP_1[OOT & EP1, all_TX & EP1, ] <- a_TDP_2[OOT & EP1, all_TX & EP1, ] <- a_TDP_3[OOT & EP1, all_TX & EP1, ] <- a_TDP_4[OOT & EP1, all_TX & EP1, ] <- 0### R&R MODIFICATION ###
  a_TDP_1[OOT & EP2, all_TX & EP2, ] <- a_TDP_2[OOT & EP2, all_TX & EP2, ] <- a_TDP_3[OOT & EP2, all_TX & EP2, ] <- a_TDP_4[OOT & EP2, all_TX & EP2, ] <- 0### R&R MODIFICATION ###
