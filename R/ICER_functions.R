...
outcomes <- function(l_params_all, 
  ...
  with(as.list(l_params_all), {
    ...
    ## Combined outcomes ##
    df_outcomes <- data.frame(n_TOTAL_costs_1yr, n_TOTAL_costs_5yr, n_TOTAL_costs_10yr, n_TOTAL_costs_life, n_HEALTH_SECTOR_costs_1yr, n_HEALTH_SECTOR_costs_5yr, n_HEALTH_SECTOR_costs_10yr, n_HEALTH_SECTOR_costs_life,
                              n_CRIMINAL_costs_1yr, n_CRIMINAL_costs_5yr, n_CRIMINAL_costs_10yr, n_CRIMINAL_costs_life, n_TX_costs_1yr, n_TX_costs_5yr, n_TX_costs_10yr, n_TX_costs_life,
...
ICER <- function(outcomes_comp, outcomes_int){
  ...
  n_qaly_TOTAL_1yr <- outcomes_int$n_TOTAL_qalys_1yr - outcomes_comp$n_TOTAL_qalys_1yr
  # 5-year
  n_costs_TOTAL_5yr <- outcomes_int$n_TOTAL_costs_5yr - outcomes_comp$n_TOTAL_costs_5yr
  n_qaly_TOTAL_5yr <- outcomes_int$n_TOTAL_qalys_5yr - outcomes_comp$n_TOTAL_qalys_5yr
  # 10-year
  n_costs_TOTAL_10yr <- outcomes_int$n_TOTAL_costs_10yr - outcomes_comp$n_TOTAL_costs_10yr
  n_qaly_TOTAL_10yr <- outcomes_int$n_TOTAL_qalys_10yr - outcomes_comp$n_TOTAL_qalys_10yr
  # Lifetime
  n_costs_TOTAL_life <- outcomes_int$n_TOTAL_costs_life - outcomes_comp$n_TOTAL_costs_life
  n_qaly_TOTAL_life <- outcomes_int$n_TOTAL_qalys_life - outcomes_comp$n_TOTAL_qalys_life
  ...
  n_qaly_HEALTH_SECTOR_1yr <- outcomes_int$n_HEALTH_SECTOR_qalys_1yr - outcomes_comp$n_HEALTH_SECTOR_qalys_1yr
  # 5-year
  n_costs_HEALTH_SECTOR_5yr <- outcomes_int$n_HEALTH_SECTOR_costs_5yr - outcomes_comp$n_HEALTH_SECTOR_costs_5yr
  n_qaly_HEALTH_SECTOR_5yr <- outcomes_int$n_HEALTH_SECTOR_qalys_5yr - outcomes_comp$n_HEALTH_SECTOR_qalys_5yr
  # 10-year
  n_costs_HEALTH_SECTOR_10yr <- outcomes_int$n_HEALTH_SECTOR_costs_10yr - outcomes_comp$n_HEALTH_SECTOR_costs_10yr
  n_qaly_HEALTH_SECTOR_10yr <- outcomes_int$n_HEALTH_SECTOR_qalys_10yr - outcomes_comp$n_HEALTH_SECTOR_qalys_10yr
  # Lifetime
  n_costs_HEALTH_SECTOR_life <- outcomes_int$n_HEALTH_SECTOR_costs_life - outcomes_comp$n_HEALTH_SECTOR_costs_life
  n_qaly_HEALTH_SECTOR_life <- outcomes_int$n_HEALTH_SECTOR_qalys_life - outcomes_comp$n_HEALTH_SECTOR_qalys_life
  ...
  df_icer <- data.frame(n_icer_TOTAL_1yr, n_icer_TOTAL_5yr, n_icer_TOTAL_10yr, n_icer_TOTAL_life,
                        ...
                        n_costs_TOTAL_1yr, n_qaly_TOTAL_1yr, n_costs_TOTAL_5yr, n_qaly_TOTAL_5yr, n_costs_TOTAL_10yr, n_qaly_TOTAL_10yr, n_costs_TOTAL_life, n_qaly_TOTAL_life,
                        n_costs_HEALTH_SECTOR_1yr, n_qaly_HEALTH_SECTOR_1yr, n_costs_HEALTH_SECTOR_5yr, n_qaly_HEALTH_SECTOR_5yr, n_costs_HEALTH_SECTOR_10yr, n_qaly_HEALTH_SECTOR_10yr, n_costs_HEALTH_SECTOR_life, n_qaly_HEALTH_SECTOR_life)
  ...
  return(list(n_icer_TOTAL_1yr = n_icer_TOTAL_1yr,
              ...
              n_qaly_TOTAL_1yr = n_qaly_TOTAL_1yr, 
              n_costs_TOTAL_5yr = n_costs_TOTAL_5yr, 
              n_qaly_TOTAL_5yr = n_qaly_TOTAL_5yr, 
              n_costs_TOTAL_10yr = n_costs_TOTAL_10yr, 
              n_qaly_TOTAL_10yr = n_qaly_TOTAL_10yr, 
              n_costs_TOTAL_life = n_costs_TOTAL_life, 
              n_qaly_TOTAL_life = n_qaly_TOTAL_life,
              n_costs_HEALTH_SECTOR_1yr = n_costs_HEALTH_SECTOR_1yr,
              n_qaly_HEALTH_SECTOR_1yr = n_qaly_HEALTH_SECTOR_1yr, 
              n_costs_HEALTH_SECTOR_5yr = n_costs_HEALTH_SECTOR_5yr, 
              n_qaly_HEALTH_SECTOR_5yr = n_qaly_HEALTH_SECTOR_5yr, 
              n_costs_HEALTH_SECTOR_10yr = n_costs_HEALTH_SECTOR_10yr, 
              n_qaly_HEALTH_SECTOR_10yr = n_qaly_HEALTH_SECTOR_10yr, 
              n_costs_HEALTH_SECTOR_life = n_costs_HEALTH_SECTOR_life, 
              n_qaly_HEALTH_SECTOR_life = n_qaly_HEALTH_SECTOR_life,
              df_icer = df_icer))  
}
