...
markov_model <- function(l_params_all, err_stop = FALSE, verbose = FALSE){
  ...
  # Buprenorphine (treatment only)
  BUP  <- df_flat$BASE == "BUP"  
  # Buprenorphine (concurrent use)
  BUPC <- df_flat$BASE == "BUPC"
  
  # Methadone (treatment only)
  MET  <- df_flat$BASE == "MET"
  # Methadone (concurrent use)
  METC <- df_flat$BASE == "METC"
  ...
  p_BUPC_ODN_NI <- p_OD(rate = n_BUPC_OD_NI, first_month = FALSE, fatal = FALSE, injection = FALSE)
  p_MET_ODN_NI  <- p_OD(rate = n_MET_OD_NI, first_month = FALSE, fatal = FALSE, injection = FALSE)
  p_METC_ODN_NI <- p_OD(rate = n_METC_OD_NI, first_month = FALSE, fatal = FALSE, injection = FALSE)
  ...
  p_BUPC_ODF_NI <- p_OD(rate = n_BUPC_OD_NI, first_month = FALSE, fatal = TRUE, injection = FALSE)
  p_MET_ODF_NI  <- p_OD(rate = n_MET_OD_NI, first_month = FALSE, fatal = TRUE, injection = FALSE)
  p_METC_ODF_NI <- p_OD(rate = n_METC_OD_NI, first_month = FALSE, fatal = TRUE, injection = FALSE)
  ...
  p_BUPC_ODN_INJ <- p_OD(rate = n_BUPC_OD_INJ, first_month = FALSE, fatal = FALSE, injection = TRUE)
  p_MET_ODN_INJ  <- p_OD(rate = n_MET_OD_INJ, first_month = FALSE, fatal = FALSE, injection = TRUE)
  p_METC_ODN_INJ <- p_OD(rate = n_METC_OD_INJ, first_month = FALSE, fatal = FALSE, injection = TRUE)
  ...
  p_BUPC_ODF_INJ <- p_OD(rate = n_BUPC_OD_INJ, first_month = FALSE, fatal = TRUE, injection = TRUE)
  p_MET_ODF_INJ  <- p_OD(rate = n_MET_OD_INJ, first_month = FALSE, fatal = TRUE, injection = TRUE)
  p_METC_ODF_INJ <- p_OD(rate = n_METC_OD_INJ, first_month = FALSE, fatal = TRUE, injection = TRUE)
  ...
  p_BUPC_ODN_NI_4wk <- p_OD(rate = n_BUPC_OD_NI, multiplier = n_BUPC_OD_mult, first_month = TRUE, fatal = FALSE, injection = FALSE)
  p_MET_ODN_NI_4wk  <- p_OD(rate = n_MET_OD_NI, multiplier = n_MET_OD_mult, first_month = TRUE, fatal = FALSE, injection = FALSE)
  p_METC_ODN_NI_4wk <- p_OD(rate = n_METC_OD_NI, multiplier = n_METC_OD_mult, first_month = TRUE, fatal = FALSE, injection = FALSE)
  ...
  p_BUPC_ODF_NI_4wk <- p_OD(rate = n_BUPC_OD_NI, multiplier = n_BUPC_OD_mult, first_month = TRUE, fatal = TRUE, injection = FALSE)
  p_MET_ODF_NI_4wk  <- p_OD(rate = n_MET_OD_NI, multiplier = n_MET_OD_mult, first_month = TRUE, fatal = TRUE, injection = FALSE)
  p_METC_ODF_NI_4wk <- p_OD(rate = n_METC_OD_NI, multiplier = n_METC_OD_mult, first_month = TRUE, fatal = TRUE, injection = FALSE)
  ...
  p_BUPC_ODN_INJ_4wk <- p_OD(rate = n_BUPC_OD_INJ, multiplier = n_BUPC_OD_mult, first_month = TRUE, fatal = FALSE, injection = TRUE)
  p_MET_ODN_INJ_4wk  <- p_OD(rate = n_MET_OD_INJ, multiplier = n_MET_OD_mult, first_month = TRUE, fatal = FALSE, injection = TRUE)
  p_METC_ODN_INJ_4wk <- p_OD(rate = n_METC_OD_INJ, multiplier = n_METC_OD_mult, first_month = TRUE, fatal = FALSE, injection = TRUE)
  ...
  p_BUPC_ODF_INJ_4wk <- p_OD(rate = n_BUPC_OD_INJ, multiplier = n_BUPC_OD_mult, first_month = TRUE, fatal = TRUE, injection = TRUE)
  p_MET_ODF_INJ_4wk  <- p_OD(rate = n_MET_OD_INJ, multiplier = n_MET_OD_mult, first_month = TRUE, fatal = TRUE, injection = TRUE)
  p_METC_ODF_INJ_4wk <- p_OD(rate = n_METC_OD_INJ, multiplier = n_METC_OD_mult, first_month = TRUE, fatal = TRUE, injection = TRUE)
