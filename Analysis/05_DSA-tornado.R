...
## Combine data frames
# Costs
df_DSA_costs_MMS <- rbind(df_overdose_costs_MMS, df_costs_MMS) %>% 
  mutate(base = tbl_df_summary_incremental_MMS[tbl_df_summary_incremental_MMS$variable == "n_inc_costs_TOTAL_life", tbl_df_summary_incremental_MMS$mean]) %>%
