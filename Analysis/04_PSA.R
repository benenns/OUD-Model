...
# Combine
df_PSA_ellipse_TOTAL <- cbind(df_incremental_PSA_MMS_TOTAL_1yr, df_incremental_PSA_MMS_TOTAL_life, df_incremental_PSA_TS_TOTAL_1yr)
...
# Combine
df_PSA_ellipse_HEALTH_SECTOR <- cbind(df_incremental_PSA_MMS_HEALTH_SECTOR_1yr, df_incremental_PSA_MMS_HEALTH_SECTOR_life, df_incremental_PSA_TS_HEALTH_SECTOR_1yr)
