...
#with(as.list(l_params_all), {
  ...
  for(i in 1){
    ...
    m_TDP_1[EP1 & ODN & NI, i]  <- m_ODN_first[EP1 & REL & NI, 1] 
    ...
    m_TDP_1[EP2 & ODN & NI, i]  <- m_ODN_first[EP2 & REL & NI, 1] 
    ...
    m_TDP_1[EP3 & ODN & NI, i]  <- m_ODN_first[EP3 & REL & NI, 1] 
    ...
    m_TDP_1[EP1 & ODN & INJ, i]  <- m_ODN_first[EP1 & REL & INJ, 1]
    ...
    m_TDP_1[EP2 & ODN & INJ, i]  <- m_ODN_first[EP2 & REL & INJ, 1]
    ...
    m_TDP_1[EP3 & ODN & INJ, i]  <- m_ODN_first[EP3 & REL & INJ, 1] # no remain, use overdose probability to set "remain"
  ...
  for (i in 1){
    a_TDP_1[, non_OD, i] <- a_UP_first[, non_OD, 1] * (1 - m_non_OD_first[non_OD, 1] - m_leave_1_non_OD[non_OD, i])
    a_TDP_2[, non_OD, i] <- a_UP_first[, non_OD, 2] * (1 - m_non_OD_first[non_OD, 2] - m_leave_2_non_OD[non_OD, i])
    a_TDP_3[, non_OD, i] <- a_UP_first[, non_OD, 3] * (1 - m_non_OD_first[non_OD, 3] - m_leave_3_non_OD[non_OD, i])
    
    a_TDP_1[, all_OD, i] <- a_UP_first[, all_OD, 1] #* (1 - m_non_OD_first[non_OD, 1] - m_leave_1_non_OD[non_OD, i])
    a_TDP_2[, all_OD, i] <- a_UP_first[, all_OD, 2] #* (1 - m_non_OD_first[non_OD, 2] - m_leave_2_non_OD[non_OD, i])
    a_TDP_3[, all_OD, i] <- a_UP_first[, all_OD, 3] #* (1 - m_non_OD_first[non_OD, 3] - m_leave_3_non_OD[non_OD, i])
  }
  # All transitions 2+ months
  for (i in 2:n_t){
    #a_TDP[, , i] <- m_UP * m_leave[, i]
    a_TDP_1[, non_OD, i] <- a_UP[, non_OD, 1] * (1 - m_non_OD[non_OD, 1] - m_leave_1_non_OD[non_OD, i])
    a_TDP_2[, non_OD, i] <- a_UP[, non_OD, 2] * (1 - m_non_OD[non_OD, 2] - m_leave_2_non_OD[non_OD, i])
    a_TDP_3[, non_OD, i] <- a_UP[, non_OD, 3] * (1 - m_non_OD[non_OD, 3] - m_leave_3_non_OD[non_OD, i])
    
    a_TDP_1[, all_OD, i] <- a_UP[, all_OD, 1] #* (1 - m_non_OD[non_OD, 1] - m_leave_1_non_OD[non_OD, i])
    a_TDP_2[, all_OD, i] <- a_UP[, all_OD, 2] #* (1 - m_non_OD[non_OD, 2] - m_leave_2_non_OD[non_OD, i])
    a_TDP_3[, all_OD, i] <- a_UP[, all_OD, 3] #* (1 - m_non_OD[non_OD, 3] - m_leave_3_non_OD[non_OD, i])
  }
